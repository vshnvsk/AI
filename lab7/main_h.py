...
class ImageProcessor:
    def __init__(self, root):
        ...
        # hopfield
        self.vector_hopfield_class1 = []
        self.vector_hopfield_class2 = []
    ...
    def open_image_window(self, image_path):
        ...
        self.process_button = tk.Button(images_window, text="Train Hopfield", command=self.process_all_images)
    ...
    def process_all_images(self):
        ...
        if self.selected_class == 1:
            ...
            vector_hopfield = self.vector_hopfield_class1
            ...
            vector_hopfield = self.vector_hopfield_class2
        else:
        ...
        # hopfield
        threshold = 0.05
        vector_hopfield = [1 if value > threshold else -1 for value in vectors_s1_avg]

        print("\nHopfield vector", vector_hopfield)
        ...
        if self.selected_class == 1:
            ...
            self.vector_hopfield_class1 = vector_hopfield
        elif self.selected_class == 2:
            self.vectors_s1_class2_avg = vectors_s1_avg
            self.vectors_m1_class2_avg = vectors_m1_avg
            self.vector_hopfield_class2 = vector_hopfield
