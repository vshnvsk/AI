...
class ImageProcessor:
    def __init__(self, root, vectors_s1_class1_max, vectors_s1_class1_min,
        ...
        self.class_vector_text = tk.Text(self.right_frame, height=3, width=40)
        ...
        self.vectors_s1_class1_max = vectors_s1_class1_max
